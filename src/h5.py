...
Usage: The examples are for PlatoSim3 HDF5 output files
  ...
  hfile = h5py.File(<filename>) or myh5.get_file(filename)

  myh5.show_file(hfile)
...
def get_file(filename, mode=None):
    """
    Load the HDF5 file.

    :param str filename: the absolute filename of the HDF5 file
    :param str mode: r, r+, w, w-, x, a (see documentation of h5py module)
